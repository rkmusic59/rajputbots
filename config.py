...
BOT_USERNAME = getenv("BOT_USERNAME" , "siyasongbot")
BOT_NAME = getenv("BOT_NAME" , "˹ꜱɪʏᴧ ꭙ ᴍᴜꜱɪᴄ˼ ♪")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/rkmusic59/rajputbots",)
