...
# Track quiz loops and active polls
quiz_loops = {}
active_polls = {}

# Fetch question from OpenTrivia API
async def fetch_quiz_question():
    categories = [9, 17, 18, 20, 21, 27]  # Random categories
...
async def quizon_start(client, message):
    ...
    await message.reply_text("**Choose a quiz interval to begin:**", reply_markup=keyboard)

# When user selects a timing
